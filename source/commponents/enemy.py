...
def create_enemy(enemy_data):
    ...
    if enemy_type == 0:
        ...
        enemy = xingxing(x, y_bottom, direction, 'xingxing', color)
...
class Enemy(pygame.sprite.Sprite):
    ...
    def load_frames(self, frame_rects):
        for frame_rect in frame_rects:
            ...
            self.left_frames.append(right_frame)
            self.right_frames.append(left_frame)
...
class xingxing(Enemy):
    def __init__(self, x, y_bottom, direction, name, color):
        bright_frame_rects = [(598, 33, 16, 17), (617,33, 17, 17), (641, 33, 22,16)]
...
class Goomba(Enemy):
    def __init__(self, x, y_bottom, direction, name, color):
        bright_frame_rects = [(8, 6, 12, 15), (27, 6, 13, 14), (46, 6, 13, 15)]
        dark_frame_rects = [(0, 48, 16, 16), (16, 48, 16, 16), [32, 48, 16, 16]]
        self.life = 2
